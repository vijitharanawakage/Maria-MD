...
//contact details
global.ownernumber = [ process.env.OWNER_NUMBER || "94741259325"],
global.ownername = process.env.OWNER_NAME || "💙𓆩‎✘𝚂𝙰𝙽𝙳𝙴𝚂 𝙼𝙳_✰",
global.ytname = "YT: AyushBotz.inc"
global.socialm = "GitHub: MRUNKNOWN"
global.location = "Sri Lankan"

global.botname = process.env.BOTNAME || "𝐊𝐈𝐍𝐆 𝐒𝐀𝐍𝐃𝐄𝐒𝐇-𝐌𝐃",//name of the bot

//sticker details
global.stickername = process.env.STICKER || "𝙄𝙏𝙯_𝙈𝙚~⦁⦀爪尺⦁𝚄𝙽𝙺𝙽𝙾𝚆ⁿ⦀⦁",
global.packname = 'Sticker By'
global.author = process.env.AUTHOR || "𝙄𝙏𝙯_𝙈𝙚~⦁⦀爪尺⦁𝚄𝙽𝙺𝙽𝙾𝚆ⁿ⦀⦁",
//console view/theme
global.themeemoji = '🧩'
global.wm = "Sandesh botz inc."

//theme link
global.link = 'https://chat.whatsapp.com/FUTRUejgTum1e9Bgi5NDIW'
